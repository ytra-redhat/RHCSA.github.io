...
TASK_1_QUESTION="Create /usr/local/bin/rhcsa_13.sh that prints first=\$1 and second=\$2. Make /usr/local/bin/rhcsa_13.sh executable."
...
TASK_2_QUESTION="Write the standard output of \`/usr/local/bin/rhcsa_13.sh alpha beta\` to /tmp/exam/ch03_13_args.txt."
