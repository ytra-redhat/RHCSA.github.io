...
TASK_1_QUESTION="Create /usr/local/bin/rhcsa_09.sh that prints hostname=<short-hostname>. Make /usr/local/bin/rhcsa_09.sh executable."
...
TASK_2_QUESTION="Write the standard output of \`/usr/local/bin/rhcsa_09.sh\` to /tmp/exam/ch03_09_host.txt."
