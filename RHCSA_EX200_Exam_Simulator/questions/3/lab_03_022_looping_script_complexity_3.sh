...
TASK_1_QUESTION="Create /usr/local/bin/rhcsa_22.sh that prints each argument"
...
TASK_2_QUESTION="Run /usr/local/bin/rhcsa_22.sh with red green blue into /tmp/exam/ch03_22_colors.txt"
TASK_2_HINT="Use /usr/local/bin/rhcsa_22.sh red green blue"
