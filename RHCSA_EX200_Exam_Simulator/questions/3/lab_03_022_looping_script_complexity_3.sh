...
TASK_1_QUESTION="Create /usr/local/bin/rhcsa_22.sh that prints each argument. Make /usr/local/bin/rhcsa_22.sh executable."
...
TASK_2_QUESTION="Write the standard output of \`/usr/local/bin/rhcsa_22.sh red green blue\` to /tmp/exam/ch03_22_colors.txt."
