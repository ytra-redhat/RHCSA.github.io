...
TASK_1_QUESTION="Create /usr/local/bin/rhcsa_04.sh that prints hostname=<short-hostname>. Make /usr/local/bin/rhcsa_04.sh executable."
...
TASK_2_QUESTION="Write the standard output of \`/usr/local/bin/rhcsa_04.sh\` to /tmp/exam/ch03_04_host.txt."
