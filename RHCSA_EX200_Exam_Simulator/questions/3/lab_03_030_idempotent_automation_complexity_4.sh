...
TASK_1_QUESTION="Create /usr/local/bin/rhcsa_30.sh that ensures /tmp/rhcsa_30 exists"
...
TASK_2_QUESTION="Run it twice and save second output in /tmp/exam/ch03_30_second.txt"
