...
TASK_1_QUESTION="Create /usr/local/bin/rhcsa_12.sh that prints each argument"
...
TASK_2_QUESTION="Run /usr/local/bin/rhcsa_12.sh with red green blue into /tmp/exam/ch03_12_colors.txt"
TASK_2_HINT="Use /usr/local/bin/rhcsa_12.sh red green blue"
