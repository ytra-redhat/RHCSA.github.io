...
TASK_1_QUESTION="Create executable /usr/local/bin/rhcsa_21.sh that prints present if /etc/passwd exists"
...
TASK_2_QUESTION="Run /usr/local/bin/rhcsa_21.sh and save output in /tmp/exam/ch03_21_run.txt"
TASK_2_HINT="Use /usr/local/bin/rhcsa_21.sh > /tmp/exam/ch03_21_run.txt"
