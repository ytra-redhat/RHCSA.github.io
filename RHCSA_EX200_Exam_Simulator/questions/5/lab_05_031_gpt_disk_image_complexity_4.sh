...
IS_LAB=true
LAB_ID="ch05_031_gpt_disk_image_complexity_4"
...
TASK_1_QUESTION="Create /var/tmp/rhcsa_31.img with an apparent size of 128M."
...
TASK_2_QUESTION="Create a GPT partition table on /var/tmp/rhcsa_31.img."
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch05_31* /tmp/rhcsa_5_31 /var/tmp/rhcsa_5_31.img
}

_check_task_1_live() {
  [[ "$(stat -c %s /var/tmp/rhcsa_31.img)" -eq 134217728 ]]
}

_check_task_2_live() {
  parted -s /var/tmp/rhcsa_31.img print | grep -qi gpt
}
