...
IS_LAB=true
LAB_ID="v10_5_3_assign_physical_volumes_to_a_volume_group_d4"
LAB_VERSION="2026.07.16-v7.0"
DIFFICULTY="4"
OBJECTIVE_TAG="Assign physical volumes to a volume group"
OBJECTIVE_IDS="5.3"
LAB_KIND="exam"
STATE_CHANGING="true"
PERSISTENCE_REQUIRED="false"
QUESTION="Assign physical volumes to a volume group"
LAB_TASK_COUNT=2
