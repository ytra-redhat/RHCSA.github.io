...
IS_LAB=true
LAB_ID="ch05_025_swap_and_capacity_complexity_3"
...
TASK_1_QUESTION="Write the standard output of \`swapon --show\` to /tmp/exam/ch05_25_swap.txt."
TASK_1_HINT="Use standard-output redirection to the requested path."
TASK_1_COMMAND_1="swapon --show > /tmp/exam/ch05_25_swap.txt"

TASK_2_QUESTION="Write the standard output of \`df -hT\` to /tmp/exam/ch05_25_df.txt."
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch05_25* /tmp/rhcsa_5_25 /var/tmp/rhcsa_5_25.img
}

_check_task_1_live() {
  [[ -f /tmp/exam/ch05_25_swap.txt ]]
}

_check_task_2_live() {
  [[ -s /tmp/exam/ch05_25_df.txt ]]
}
