...
IS_LAB=true
LAB_ID="ch05_037_storage_inventory_complexity_5"
...
TASK_1_QUESTION="Write the standard output of \`lsblk -f\` to /tmp/exam/ch05_37_lsblk.txt."
...
TASK_2_QUESTION="blkid and write both standard output and standard error to /tmp/exam/ch05_37_blkid.txt."
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch05_37* /tmp/rhcsa_5_37 /var/tmp/rhcsa_5_37.img
}

_check_task_1_live() {
  [[ -s /tmp/exam/ch05_37_lsblk.txt ]]
}

_check_task_2_live() {
  [[ -f /tmp/exam/ch05_37_blkid.txt ]]
}
