...
IS_LAB=true
LAB_ID="v10_5_3_assign_physical_volumes_to_a_volume_grou_d3"
LAB_VERSION="2026.07.16-v7.0"
DIFFICULTY="3"
OBJECTIVE_TAG="Assign physical volumes to a volume group - practice level 3"
OBJECTIVE_IDS="5.3"
LAB_KIND="exam"
STATE_CHANGING="true"
PERSISTENCE_REQUIRED="false"
QUESTION="Assign physical volumes to a volume group - practice level 3"
LAB_TASK_COUNT=2
...
TASK_2_QUESTION="Add the device named in /tmp/exam/v10/5.3/device2 to rhcsa_v10_vg."
TASK_2_HINT="Initialize the second device and extend the existing VG."
TASK_2_COMMAND_1="pvcreate -ff -y \"\$(cat /tmp/exam/v10/5.3/device2)\" && vgextend rhcsa_v10_vg \"\$(cat /tmp/exam/v10/5.3/device2)\""
...
_check_task_2_live() {
  [[ "$(vgs --noheadings -o pv_count rhcsa_v10_vg | xargs)" -eq 2 ]]
}
