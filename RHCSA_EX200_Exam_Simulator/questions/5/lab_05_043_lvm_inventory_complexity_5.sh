...
TASK_1_QUESTION="pvs and write both standard output and standard error to /tmp/exam/ch05_43_pvs.txt."
...
TASK_2_QUESTION="lvs and write both standard output and standard error to /tmp/exam/ch05_43_lvs.txt."
