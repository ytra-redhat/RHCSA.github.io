...
TASK_1_QUESTION="Create a 128 MiB disk image /var/tmp/rhcsa_06.img"
TASK_1_HINT="Use truncate -s 128M"
TASK_1_COMMAND_1="truncate -s 128M /var/tmp/rhcsa_06.img"

TASK_2_QUESTION="Create a GPT label on /var/tmp/rhcsa_06.img"
TASK_2_HINT="Use parted -s /var/tmp/rhcsa_06.img mklabel gpt"
