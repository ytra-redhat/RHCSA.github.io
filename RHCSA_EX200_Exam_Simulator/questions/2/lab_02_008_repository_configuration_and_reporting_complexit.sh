...
TASK_1_QUESTION="Create a repository definition in /tmp/exam/ch02_08.repo"
TASK_1_HINT="Create a repo with id lab08, file baseurl, enabled=1 and gpgcheck=0"
TASK_1_COMMAND_1="printf '[lab08]\\nname=Lab 08\\nbaseurl=file:///tmp/repo08\\nenabled=1\\ngpgcheck=0\\n' > /tmp/exam/ch02_08.repo"

TASK_2_QUESTION="Save enabled repositories in /tmp/exam/ch02_08_repos.txt"
