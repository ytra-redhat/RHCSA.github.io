...
IS_LAB=true
LAB_ID="ch02_028_repository_configuration_and_reporting_complexit"
...
TASK_2_QUESTION="dnf repolist enabled and write both standard output and standard error to /tmp/exam/ch02_28_repos.txt."
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch02_28* /tmp/rhcsa_2_28 /var/tmp/rhcsa_2_28.img
}

_check_task_1_live() {
  grep -Fxq "enabled=1" /tmp/exam/ch02_28.repo && grep -Fxq "gpgcheck=0" /tmp/exam/ch02_28.repo
}

_check_task_2_live() {
  [[ -s /tmp/exam/ch02_28_repos.txt ]]
}
