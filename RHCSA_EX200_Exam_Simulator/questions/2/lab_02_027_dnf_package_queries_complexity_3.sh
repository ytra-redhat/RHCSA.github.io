...
TASK_1_QUESTION="dnf info bash and write both standard output and standard error to /tmp/exam/ch02_27_info.txt."
TASK_1_HINT="Use file descriptor 2 redirection."
TASK_1_COMMAND_1="dnf info bash > /tmp/exam/ch02_27_info.txt 2>&1"

TASK_2_QUESTION="dnf provides /usr/bin/awk and write both standard output and standard error to /tmp/exam/ch02_27_provider.txt."
