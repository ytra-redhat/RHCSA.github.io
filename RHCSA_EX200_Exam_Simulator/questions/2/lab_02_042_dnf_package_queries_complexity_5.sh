...
TASK_1_QUESTION="Save dnf info for bash in /tmp/exam/ch02_42_info.txt"
TASK_1_HINT="Use dnf info bash"
TASK_1_COMMAND_1="dnf info bash > /tmp/exam/ch02_42_info.txt 2>&1"

TASK_2_QUESTION="Save provider results for /usr/bin/awk in /tmp/exam/ch02_42_provider.txt"
