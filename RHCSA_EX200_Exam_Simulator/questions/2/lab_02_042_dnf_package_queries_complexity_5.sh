...
TASK_1_QUESTION="dnf info bash and write both standard output and standard error to /tmp/exam/ch02_42_info.txt."
...
TASK_2_QUESTION="dnf provides /usr/bin/awk and write both standard output and standard error to /tmp/exam/ch02_42_provider.txt."
