...
TASK_1_QUESTION="Write the standard output of \`rpm -qi bash\` to /tmp/exam/ch02_21_rpm.txt."
TASK_1_HINT="Use standard-output redirection to the requested path."
TASK_1_COMMAND_1="rpm -qi bash > /tmp/exam/ch02_21_rpm.txt"

TASK_2_QUESTION="Write the standard output of \`rpm -ql bash\` to /tmp/exam/ch02_21_files.txt."
