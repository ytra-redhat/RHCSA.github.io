...
IS_LAB=true
LAB_ID="ch02_009_install_and_inspect_safe_software_complexity_1"
...
TASK_2_QUESTION="Write the standard output of \`rpm -qi bash-completion\` to /tmp/exam/ch02_09_pkg.txt."
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch02_09* /tmp/rhcsa_2_09 /var/tmp/rhcsa_2_09.img
}
...
_check_task_2_live() {
  grep -Eqi "^Name.*bash-completion" /tmp/exam/ch02_09_pkg.txt
}
