...
TASK_2_QUESTION="Run rpm -qi bash-completion and write the complete standard output to /tmp/exam/ch02_24_pkg.txt. Overwrite the destination if it already exists. The task is complete when the destination file exists and contains the requested command output."
TASK_2_HINT="Suggested command: rpm -qi bash-completion > /tmp/exam/ch02_24_pkg.txt. Explanation: > overwrites the destination with standard output. rpm -qi queries installed-package metadata."
