...
IS_LAB=true
LAB_ID="ch08_031_networkmanager_inventory_complexity_4"
...
TASK_1_QUESTION="Save connections in /tmp/exam/ch08_31_connections.txt"
TASK_1_HINT="Use nmcli -t connection show"
TASK_1_COMMAND_1="nmcli -t connection show > /tmp/exam/ch08_31_connections.txt"

TASK_2_QUESTION="Save device status in /tmp/exam/ch08_31_devices.txt"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch08_31* /tmp/rhcsa_8_31 /var/tmp/rhcsa_8_31.img
}

_check_task_1_live() {
  [[ -f /tmp/exam/ch08_31_connections.txt ]]
}

_check_task_2_live() {
  [[ -s /tmp/exam/ch08_31_devices.txt ]]
}
