...
TASK_1_QUESTION="firewall-cmd --get-active-zones and write both standard output and standard error to /tmp/exam/ch08_45_zones.txt."
...
TASK_2_QUESTION="firewall-cmd --zone=public --list-all and write both standard output and standard error to /tmp/exam/ch08_45_public.txt."
