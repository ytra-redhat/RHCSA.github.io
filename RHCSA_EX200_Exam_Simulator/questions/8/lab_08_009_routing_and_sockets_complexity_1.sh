...
TASK_1_QUESTION="Write the standard output of \`ip route show\` to /tmp/exam/ch08_09_routes.txt."
...
TASK_2_QUESTION="Write the standard output of \`ss -lnt\` to /tmp/exam/ch08_09_sockets.txt."
