...
IS_LAB=true
LAB_ID="ch08_040_firewall_zones_complexity_5"
...
TASK_1_QUESTION="Save active zones in /tmp/exam/ch08_40_zones.txt"
...
TASK_2_QUESTION="Save public zone data in /tmp/exam/ch08_40_public.txt"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch08_40* /tmp/rhcsa_8_40 /var/tmp/rhcsa_8_40.img
}

_check_task_1_live() {
  [[ -f /tmp/exam/ch08_40_zones.txt ]]
}

_check_task_2_live() {
  [[ -f /tmp/exam/ch08_40_public.txt ]]
}
