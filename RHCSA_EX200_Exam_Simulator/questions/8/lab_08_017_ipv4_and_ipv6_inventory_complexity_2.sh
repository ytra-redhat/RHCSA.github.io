...
TASK_1_QUESTION="Write the standard output of \`ip -4 address show\` to /tmp/exam/ch08_17_ipv4.txt."
...
TASK_2_QUESTION="Write the standard output of \`ip -6 address show\` to /tmp/exam/ch08_17_ipv6.txt."
