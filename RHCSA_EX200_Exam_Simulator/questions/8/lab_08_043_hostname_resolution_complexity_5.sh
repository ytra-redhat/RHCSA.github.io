...
TASK_1_QUESTION="Create hosts artifact /tmp/exam/ch08_43_hosts"
TASK_1_HINT="Write 192.0.2.43 server43.example.com server43"
TASK_1_COMMAND_1="printf '192.0.2.43 server43.example.com server43\\n' > /tmp/exam/ch08_43_hosts"

TASK_2_QUESTION="Save resolver configuration in /tmp/exam/ch08_43_resolver.txt"
