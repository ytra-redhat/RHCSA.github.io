...
IS_LAB=true
LAB_ID="ch08_003_hostname_resolution_complexity_1"
...
TASK_2_QUESTION="Write the standard output of \`cat /etc/resolv.conf\` to /tmp/exam/ch08_03_resolver.txt."
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch08_03* /tmp/rhcsa_8_03 /var/tmp/rhcsa_8_03.img
}

_check_task_1_live() {
  [[ -s /tmp/exam/ch08_03_hosts ]]
}

_check_task_2_live() {
  [[ -s /tmp/exam/ch08_03_resolver.txt ]]
}
