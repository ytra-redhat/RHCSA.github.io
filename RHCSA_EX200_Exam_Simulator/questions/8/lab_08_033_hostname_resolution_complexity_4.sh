...
TASK_1_QUESTION="Create hosts artifact /tmp/exam/ch08_33_hosts"
TASK_1_HINT="Write 192.0.2.33 server33.example.com server33"
TASK_1_COMMAND_1="printf '192.0.2.33 server33.example.com server33\\n' > /tmp/exam/ch08_33_hosts"

TASK_2_QUESTION="Save resolver configuration in /tmp/exam/ch08_33_resolver.txt"
