...
TASK_1_QUESTION="Create /tmp/exam/ch01_43.tar.gz containing /etc/hosts"
TASK_1_HINT="Use tar -czf /tmp/exam/ch01_43.tar.gz /etc/hosts"
TASK_1_COMMAND_1="tar -czf /tmp/exam/ch01_43.tar.gz /etc/hosts"

TASK_2_QUESTION="Create /tmp/exam/ch01_43.tar.bz2 containing /etc/services"
TASK_2_HINT="Use tar -cjf /tmp/exam/ch01_43.tar.bz2 /etc/services"
