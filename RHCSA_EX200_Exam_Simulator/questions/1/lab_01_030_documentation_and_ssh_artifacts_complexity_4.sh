...
TASK_1_QUESTION="Write the standard output of \`apropos passwd\` to /tmp/exam/ch01_30_apropos.txt."
...
TASK_2_QUESTION="Create an Ed25519 SSH key pair at /tmp/exam/ch01_30_key without a passphrase."
