...
TASK_1_QUESTION="Write the standard output of \`grep '^root:' /etc/passwd\` to /tmp/exam/ch01_02_root.txt."
...
TASK_2_QUESTION="Write the standard output of \`grep -E ':/(bin/)?bash\$' /etc/passwd\` to /tmp/exam/ch01_02_bash.txt."
