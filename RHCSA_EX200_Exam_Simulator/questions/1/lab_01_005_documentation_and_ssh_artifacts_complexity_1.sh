...
TASK_1_QUESTION="Save apropos matches for passwd in /tmp/exam/ch01_05_apropos.txt"
TASK_1_HINT="Use apropos passwd"
TASK_1_COMMAND_1="apropos passwd > /tmp/exam/ch01_05_apropos.txt"

TASK_2_QUESTION="Generate an ed25519 key at /tmp/exam/ch01_05_key"
TASK_2_HINT="Use ssh-keygen -t ed25519 -N \"\" -f /tmp/exam/ch01_05_key"
