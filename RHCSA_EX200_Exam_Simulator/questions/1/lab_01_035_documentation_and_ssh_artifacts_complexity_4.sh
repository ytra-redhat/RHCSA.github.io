...
IS_LAB=true
LAB_ID="ch01_035_documentation_and_ssh_artifacts_complexity_4"
LAB_VERSION="2026.07.12-v2.0"
DIFFICULTY="4"
OBJECTIVE_TAG="permissions"
OBJECTIVE_IDS="1.4,1.10,1.11"
LAB_KIND="drill"
STATE_CHANGING="true"
...
TASK_1_QUESTION="Write the standard output of \`apropos passwd\` to /tmp/exam/ch01_35_apropos.txt."
...
TASK_2_QUESTION="Create an Ed25519 SSH key pair at /tmp/exam/ch01_35_key without a passphrase."
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch01_35* /tmp/rhcsa_1_35 /var/tmp/rhcsa_1_35.img
}

_check_task_1_live() {
  [[ -s /tmp/exam/ch01_35_apropos.txt ]]
}

_check_task_2_live() {
  [[ -f /tmp/exam/ch01_35_key && -f /tmp/exam/ch01_35_key.pub ]]
}
