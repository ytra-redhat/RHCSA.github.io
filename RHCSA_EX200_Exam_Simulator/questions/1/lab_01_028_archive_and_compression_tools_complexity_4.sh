...
IS_LAB=true
LAB_ID="ch01_028_archive_and_compression_tools_complexity_4"
LAB_VERSION="2026.07.12-v2.0"
DIFFICULTY="4"
OBJECTIVE_TAG="redirection"
OBJECTIVE_IDS="1.2,1.6"
LAB_KIND="drill"
STATE_CHANGING="true"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch01_28* /tmp/rhcsa_1_28 /var/tmp/rhcsa_1_28.img
}

_check_task_1_live() {
  tar -tzf /tmp/exam/ch01_28.tar.gz | grep -q etc/hosts
}

_check_task_2_live() {
  tar -tjf /tmp/exam/ch01_28.tar.bz2 | grep -q etc/services
}
