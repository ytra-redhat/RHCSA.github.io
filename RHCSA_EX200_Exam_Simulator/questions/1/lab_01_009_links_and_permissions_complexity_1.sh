...
TASK_1_HINT="Suggested command: echo data > /tmp/exam/ch01_09_source; ln /tmp/exam/ch01_09_source /tmp/exam/ch01_09_hard. Explanation: > overwrites the destination with standard output."
TASK_1_COMMAND_1="echo data > /tmp/exam/ch01_09_source; ln /tmp/exam/ch01_09_source /tmp/exam/ch01_09_hard"

TASK_2_QUESTION="Create the regular file /tmp/exam/ch01_09_private and set its numeric mode to exactly 640. The file may be empty."
TASK_2_HINT="Suggested command: install -m 640 /dev/null /tmp/exam/ch01_09_private. Explanation: install creates the file and applies the requested mode in one operation."
