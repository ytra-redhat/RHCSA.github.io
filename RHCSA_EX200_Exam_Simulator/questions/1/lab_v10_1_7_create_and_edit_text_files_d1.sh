...
IS_LAB=true
LAB_ID="v10_1_7_create_and_edit_text_files_d1"
LAB_VERSION="2026.07.16-v7.0"
DIFFICULTY="1"
OBJECTIVE_TAG="Create and edit text files - practice level 1"
OBJECTIVE_IDS="1.7"
LAB_KIND="exam"
STATE_CHANGING="true"
PERSISTENCE_REQUIRED="false"
QUESTION="Create and edit text files - practice level 1"
LAB_TASK_COUNT=1
