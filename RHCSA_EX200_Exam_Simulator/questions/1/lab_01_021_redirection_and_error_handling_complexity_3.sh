...
TASK_1_QUESTION="Write the kernel release to /tmp/exam/ch01_21_kernel.txt"
TASK_1_HINT="Use uname -r > /tmp/exam/ch01_21_kernel.txt"
TASK_1_COMMAND_1="uname -r > /tmp/exam/ch01_21_kernel.txt"

TASK_2_QUESTION="Capture stderr from a missing path in /tmp/exam/ch01_21_error.txt"
TASK_2_HINT="Use ls /missing-rhcsa-21 2> /tmp/exam/ch01_21_error.txt"
