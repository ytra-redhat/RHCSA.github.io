...
TASK_1_QUESTION="Write the running kernel release to /tmp/exam/ch01_26_kernel.txt."
TASK_1_HINT="Use standard-output redirection to the requested path."
TASK_1_COMMAND_1="uname -r > /tmp/exam/ch01_26_kernel.txt"

TASK_2_QUESTION="Write only the error produced for /missing-rhcsa-26 to /tmp/exam/ch01_26_error.txt."
