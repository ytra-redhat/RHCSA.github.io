...
TASK_1_QUESTION="tuned-adm active and write both standard output and standard error to /tmp/exam/ch04_40_tuned.txt."
...
TASK_2_QUESTION="Write the standard output of \`ps -eo pid,ni,comm\` to /tmp/exam/ch04_40_nice.txt."
