...
TASK_1_QUESTION="Write the standard output of \`systemctl get-default\` to /tmp/exam/ch04_19_target.txt."
...
TASK_2_QUESTION="Write the standard output of \`systemctl list-unit-files --type=target --no-pager\` to /tmp/exam/ch04_19_targets.txt."
