...
IS_LAB=true
LAB_ID="v10_4_1_normal_reboot_and_shutdown_workflow_d1"
LAB_VERSION="2026.07.16-v7.0"
DIFFICULTY="1"
OBJECTIVE_TAG="Normal reboot and shutdown workflow - practice level 1"
OBJECTIVE_IDS="4.1"
LAB_KIND="guided-manual"
STATE_CHANGING="true"
PERSISTENCE_REQUIRED="reboot"
QUESTION="Normal reboot and shutdown workflow - practice level 1"
LAB_TASK_COUNT=1
