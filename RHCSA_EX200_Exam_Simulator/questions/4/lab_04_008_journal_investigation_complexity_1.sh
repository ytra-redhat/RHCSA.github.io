...
IS_LAB=true
LAB_ID="ch04_008_journal_investigation_complexity_1"
...
TASK_1_QUESTION="Save current boot warnings in /tmp/exam/ch04_08_warnings.txt"
...
TASK_2_QUESTION="Save sshd journal entries in /tmp/exam/ch04_08_sshd.txt"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch04_08* /tmp/rhcsa_4_08 /var/tmp/rhcsa_4_08.img
}

_check_task_1_live() {
  [[ -f /tmp/exam/ch04_08_warnings.txt ]]
}

_check_task_2_live() {
  [[ -f /tmp/exam/ch04_08_sshd.txt ]]
}
