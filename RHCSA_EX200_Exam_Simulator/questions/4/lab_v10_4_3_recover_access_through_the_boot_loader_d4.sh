...
IS_LAB=true
LAB_ID="v10_4_3_recover_access_through_the_boot_loader_d4"
LAB_VERSION="2026.07.16-v7.0"
DIFFICULTY="4"
OBJECTIVE_TAG="Recover access through the boot loader"
OBJECTIVE_IDS="4.3"
LAB_KIND="guided-manual"
STATE_CHANGING="false"
PERSISTENCE_REQUIRED="reboot"
QUESTION="Recover access through the boot loader"
LAB_TASK_COUNT=2
