...
IS_LAB=true
LAB_ID="v10_4_3_recover_access_through_the_boot_loader_d3"
LAB_VERSION="2026.07.16-v7.0"
DIFFICULTY="3"
OBJECTIVE_TAG="Recover access through the boot loader - practice level 3"
OBJECTIVE_IDS="4.3"
LAB_KIND="guided-manual"
STATE_CHANGING="false"
PERSISTENCE_REQUIRED="reboot"
QUESTION="Recover access through the boot loader - practice level 3"
LAB_TASK_COUNT=2
...
TASK_2_QUESTION="Write recovered to /var/tmp/rhcsa-v10-boot-recovery after the normal system has booted."
TASK_2_HINT="This confirms the marker is writable in the recovered system."
TASK_2_COMMAND_1="printf \"recovered\\n\" > /var/tmp/rhcsa-v10-boot-recovery"
...
_check_task_2_live() {
  grep -Fxq recovered /var/tmp/rhcsa-v10-boot-recovery
}
