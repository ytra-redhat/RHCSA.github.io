...
TASK_1_QUESTION="tuned-adm active and write both standard output and standard error to /tmp/exam/ch04_10_tuned.txt."
TASK_1_HINT="Use file descriptor 2 redirection."
TASK_1_COMMAND_1="tuned-adm active > /tmp/exam/ch04_10_tuned.txt 2>&1"

TASK_2_QUESTION="Write the standard output of \`ps -eo pid,ni,comm\` to /tmp/exam/ch04_10_nice.txt."
