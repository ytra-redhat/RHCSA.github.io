...
IS_LAB=true
LAB_ID="v10_4_2_use_systemd_targets_d3"
LAB_VERSION="2026.07.16-v7.0"
DIFFICULTY="3"
OBJECTIVE_TAG="Use systemd targets - practice level 3"
OBJECTIVE_IDS="4.2"
LAB_KIND="exam"
STATE_CHANGING="true"
PERSISTENCE_REQUIRED="true"
QUESTION="Use systemd targets - practice level 3"
LAB_TASK_COUNT=2
...
TASK_2_QUESTION="Switch the running system to multi-user.target."
TASK_2_HINT="Use target isolation and verify the active target."
TASK_2_COMMAND_1="systemctl isolate multi-user.target"
