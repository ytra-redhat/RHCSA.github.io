...
TASK_1_QUESTION="Write the standard output of \`getsebool -a | grep httpd\` to /tmp/exam/ch10_03_bool.txt."
...
TASK_2_QUESTION="Write the standard output of \`semanage port -l | grep http_port_t\` to /tmp/exam/ch10_03_ports.txt."
