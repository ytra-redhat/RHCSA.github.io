...
IS_LAB=true
LAB_ID="ch10_034_ssh_key_authentication_complexity_4"
LAB_VERSION="2026.07.12-v2.0"
DIFFICULTY="4"
OBJECTIVE_TAG="umask"
OBJECTIVE_IDS="10.2,10.3"
LAB_KIND="drill"
STATE_CHANGING="true"
...
TASK_1_QUESTION="Create an Ed25519 SSH key pair at /tmp/exam/ch10_34_key without a passphrase."
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch10_34* /tmp/rhcsa_10_34 /var/tmp/rhcsa_10_34.img
}

_check_task_1_live() {
  [[ -f /tmp/exam/ch10_34_key.pub ]]
}

_check_task_2_live() {
  [[ "$(stat -c %a /tmp/exam/ch10_34_authorized)" = 600 ]]
}
...
cleanup_lab() {
  rm -rf /tmp/exam/ch10_34* /tmp/rhcsa_10_34 /var/tmp/rhcsa_10_34.img; semanage fcontext -d "/tmp/rhcsa_web_34(/.*)?" 2>/dev/null || true
}
