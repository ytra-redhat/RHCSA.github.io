...
TASK_1_QUESTION="Create directory /tmp/rhcsa_web_02, including any missing parent directories. The exact path must exist."
TASK_1_HINT="Suggested command: mkdir -p /tmp/rhcsa_web_02. Explanation: mkdir -p creates the directory and any missing parent directories."
...
TASK_2_HINT="Suggested command: semanage fcontext -a -t httpd_sys_content_t '/tmp/rhcsa_web_02(/.*)?'; restorecon -Rv /tmp/rhcsa_web_02. Explanation: semanage fcontext records a persistent SELinux mapping and restorecon applies it."
