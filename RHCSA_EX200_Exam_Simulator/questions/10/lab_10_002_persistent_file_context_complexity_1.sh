...
TASK_1_QUESTION="Create directory /tmp/rhcsa_web_02"
TASK_1_HINT="Use mkdir -p /tmp/rhcsa_web_02"
TASK_1_COMMAND_1="mkdir -p /tmp/rhcsa_web_02"

TASK_2_QUESTION="Assign persistent httpd_sys_content_t to /tmp/rhcsa_web_02"
