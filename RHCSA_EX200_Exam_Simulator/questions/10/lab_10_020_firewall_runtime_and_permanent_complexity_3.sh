...
TASK_1_QUESTION="firewall-cmd --zone=public --list-services and write both standard output and standard error to /tmp/exam/ch10_20_runtime.txt."
...
TASK_2_QUESTION="firewall-cmd --permanent --zone=public --list-services and write both standard output and standard error to /tmp/exam/ch10_20_permanent.txt."
