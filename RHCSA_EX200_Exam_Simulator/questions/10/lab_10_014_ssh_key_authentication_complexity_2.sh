...
TASK_1_QUESTION="Generate key /tmp/exam/ch10_14_key"
TASK_1_HINT="Use ssh-keygen -t ed25519 -N \"\" -f /tmp/exam/ch10_14_key"
TASK_1_COMMAND_1="ssh-keygen -q -t ed25519 -N \"\" -f /tmp/exam/ch10_14_key"

TASK_2_QUESTION="Create authorized_keys artifact /tmp/exam/ch10_14_authorized"
