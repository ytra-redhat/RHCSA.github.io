...
TASK_1_QUESTION="Write the standard output of \`findmnt\` to /tmp/exam/ch06_45_mounts.txt."
...
TASK_2_QUESTION="Write the standard output of \`(xfs_info / 2>/dev/null || lsblk -f)\` to /tmp/exam/ch06_45_xfs.txt."
