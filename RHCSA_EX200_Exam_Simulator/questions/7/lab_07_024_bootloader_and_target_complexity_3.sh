...
TASK_1_QUESTION="Write the standard output of \`systemctl get-default\` to /tmp/exam/ch07_24_target.txt."
...
TASK_2_QUESTION="grub2-editenv list and write both standard output and standard error to /tmp/exam/ch07_24_grub.txt."
