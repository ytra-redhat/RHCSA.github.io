...
TASK_1_QUESTION="Write the standard output of \`timedatectl\` to /tmp/exam/ch07_28_time.txt."
...
TASK_2_QUESTION="chronyc sources and write both standard output and standard error to /tmp/exam/ch07_28_chrony.txt."
