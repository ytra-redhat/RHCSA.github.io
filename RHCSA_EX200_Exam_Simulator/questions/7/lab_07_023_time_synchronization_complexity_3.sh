...
TASK_1_QUESTION="Write the standard output of \`timedatectl\` to /tmp/exam/ch07_23_time.txt."
TASK_1_HINT="Use standard-output redirection to the requested path."
TASK_1_COMMAND_1="timedatectl > /tmp/exam/ch07_23_time.txt"

TASK_2_QUESTION="chronyc sources and write both standard output and standard error to /tmp/exam/ch07_23_chrony.txt."
