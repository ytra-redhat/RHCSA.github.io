...
IS_LAB=true
LAB_ID="ch07_038_time_synchronization_complexity_5"
...
TASK_1_QUESTION="Write the standard output of \`timedatectl\` to /tmp/exam/ch07_38_time.txt."
...
TASK_2_QUESTION="chronyc sources and write both standard output and standard error to /tmp/exam/ch07_38_chrony.txt."
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch07_38* /tmp/rhcsa_7_38 /var/tmp/rhcsa_7_38.img
}

_check_task_1_live() {
  [[ -s /tmp/exam/ch07_38_time.txt ]]
}

_check_task_2_live() {
  [[ -f /tmp/exam/ch07_38_chrony.txt ]]
}
