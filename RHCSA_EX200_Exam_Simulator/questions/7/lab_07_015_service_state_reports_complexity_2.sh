...
TASK_1_QUESTION="systemctl is-enabled sshd and write both standard output and standard error to /tmp/exam/ch07_15_enabled.txt."
TASK_1_HINT="Use file descriptor 2 redirection."
TASK_1_COMMAND_1="systemctl is-enabled sshd > /tmp/exam/ch07_15_enabled.txt 2>&1"

TASK_2_QUESTION="systemctl status sshd --no-pager and write both standard output and standard error to /tmp/exam/ch07_15_status.txt."
