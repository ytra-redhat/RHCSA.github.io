...
TASK_1_HINT="Suggested command: printf '15 2 * * * root date\\n' > /tmp/exam/ch07_26_daily. Explanation: > overwrites the destination with standard output. printf writes deterministic text, including the requested line breaks."
...
TASK_2_HINT="Suggested command: printf '0 4 * * 0 root date\\n' > /tmp/exam/ch07_26_weekly. Explanation: > overwrites the destination with standard output. printf writes deterministic text, including the requested line breaks."
