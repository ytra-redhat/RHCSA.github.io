...
IS_LAB=true
LAB_ID="ch07_043_time_synchronization_complexity_5"
...
TASK_1_QUESTION="Save timedatectl in /tmp/exam/ch07_43_time.txt"
TASK_1_HINT="Use timedatectl"
TASK_1_COMMAND_1="timedatectl > /tmp/exam/ch07_43_time.txt"

TASK_2_QUESTION="Save chrony sources in /tmp/exam/ch07_43_chrony.txt"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch07_43* /tmp/rhcsa_7_43 /var/tmp/rhcsa_7_43.img
}

_check_task_1_live() {
  [[ -s /tmp/exam/ch07_43_time.txt ]]
}

_check_task_2_live() {
  [[ -f /tmp/exam/ch07_43_chrony.txt ]]
}
