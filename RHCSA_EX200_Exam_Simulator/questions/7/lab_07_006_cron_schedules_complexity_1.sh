...
IS_LAB=true
LAB_ID="ch07_006_cron_schedules_complexity_1"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch07_06* /tmp/rhcsa_7_06 /var/tmp/rhcsa_7_06.img
}

_check_task_1_live() {
  grep -Fxq "15 2 * * * root date" /tmp/exam/ch07_06_daily
}

_check_task_2_live() {
  grep -Fxq "0 4 * * 0 root date" /tmp/exam/ch07_06_weekly
}
