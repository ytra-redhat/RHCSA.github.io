...
TASK_1_QUESTION="grep \"^\$(whoami):\" /etc/subuid and write both standard output and standard error to /tmp/exam/ch11_34_subuid.txt."
...
TASK_2_QUESTION="podman info and write both standard output and standard error to /tmp/exam/ch11_34_info.txt."
