...
IS_LAB=true
LAB_ID="ch11_033_container_volume_and_port_plan_complexity_4"
...
TASK_1_QUESTION="Create volume directory /tmp/exam/ch11_33_volume mode 775"
TASK_1_HINT="Use install -d -m 775"
TASK_1_COMMAND_1="install -d -m 775 /tmp/exam/ch11_33_volume"

TASK_2_QUESTION="Create run command artifact /tmp/exam/ch11_33_run.txt"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch11_33* /tmp/rhcsa_11_33 /var/tmp/rhcsa_11_33.img
}

_check_task_1_live() {
  [[ "$(stat -c %a /tmp/exam/ch11_33_volume)" = 775 ]]
}

_check_task_2_live() {
  grep -q 8080:80 /tmp/exam/ch11_33_run.txt
}
