...
IS_LAB=true
LAB_ID="ch11_005_quadlet_artifact_complexity_1"
...
TASK_1_QUESTION="Create /tmp/exam/ch11_05.container with an Image line"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch11_05* /tmp/rhcsa_11_05 /var/tmp/rhcsa_11_05.img
}

_check_task_1_live() {
  grep -Fxq "Image=registry.example.com/app:latest" /tmp/exam/ch11_05.container
}

_check_task_2_live() {
  grep -Fxq "WantedBy=default.target" /tmp/exam/ch11_05.container
}
