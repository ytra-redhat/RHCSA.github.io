...
IS_LAB=true
LAB_ID="ch11_039_rootless_container_reports_complexity_5"
...
TASK_1_QUESTION="Save subordinate IDs in /tmp/exam/ch11_39_subuid.txt"
...
TASK_2_QUESTION="Save podman info in /tmp/exam/ch11_39_info.txt"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch11_39* /tmp/rhcsa_11_39 /var/tmp/rhcsa_11_39.img
}

_check_task_1_live() {
  [[ -f /tmp/exam/ch11_39_subuid.txt ]]
}

_check_task_2_live() {
  [[ -f /tmp/exam/ch11_39_info.txt ]]
}
