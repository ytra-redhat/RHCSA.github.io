...
TASK_1_QUESTION="podman ps -a and write both standard output and standard error to /tmp/exam/ch11_01_containers.txt."
TASK_1_HINT="Use file descriptor 2 redirection."
TASK_1_COMMAND_1="podman ps -a > /tmp/exam/ch11_01_containers.txt 2>&1"

TASK_2_QUESTION="podman images and write both standard output and standard error to /tmp/exam/ch11_01_images.txt."
