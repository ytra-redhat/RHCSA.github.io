...
TASK_1_QUESTION="Write the standard output of \`getent passwd root\` to /tmp/exam/ch09_05_passwd.txt."
...
TASK_2_QUESTION="Write the standard output of \`id root\` to /tmp/exam/ch09_05_id.txt."
