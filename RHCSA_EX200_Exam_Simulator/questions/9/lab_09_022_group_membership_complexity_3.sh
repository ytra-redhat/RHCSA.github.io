...
TASK_1_QUESTION="Create group rhcsa_g22"
TASK_1_HINT="Use groupadd rhcsa_g22"
TASK_1_COMMAND_1="groupadd rhcsa_g22"

TASK_2_QUESTION="Create user rhcsa_u22 in supplementary group rhcsa_g22"
TASK_2_HINT="Use useradd -m -G rhcsa_g22 rhcsa_u22"
