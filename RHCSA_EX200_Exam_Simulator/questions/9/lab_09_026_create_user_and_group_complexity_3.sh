...
TASK_1_QUESTION="Create user rhcsa_u26 with home"
TASK_1_HINT="Use useradd -m rhcsa_u26"
TASK_1_COMMAND_1="useradd -m rhcsa_u26"

TASK_2_QUESTION="Create group rhcsa_g26"
TASK_2_HINT="Use groupadd rhcsa_g26"
