...
TASK_1_QUESTION="Create user rhcsa_u23"
TASK_1_HINT="Use useradd -m rhcsa_u23"
TASK_1_COMMAND_1="useradd -m rhcsa_u23"

TASK_2_QUESTION="Set maximum password age to 45 for rhcsa_u23"
TASK_2_HINT="Use chage -M 45 rhcsa_u23"
