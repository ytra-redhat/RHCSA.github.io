...
TASK_1_QUESTION="Create local user rhcsa_u08 with the options required by the task title."
...
TASK_2_QUESTION="Set the maximum password age for user rhcsa_u08 to exactly 45 days."
