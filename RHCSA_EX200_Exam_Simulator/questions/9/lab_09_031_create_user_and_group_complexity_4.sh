...
TASK_1_QUESTION="Create user rhcsa_u31 with home"
TASK_1_HINT="Use useradd -m rhcsa_u31"
TASK_1_COMMAND_1="useradd -m rhcsa_u31"

TASK_2_QUESTION="Create group rhcsa_g31"
TASK_2_HINT="Use groupadd rhcsa_g31"
