...
TASK_1_QUESTION="Save subscription identity in /tmp/exam/ch12_28_identity.txt"
...
TASK_2_QUESTION="Save enabled subscription repositories in /tmp/exam/ch12_28_repos.txt"
