...
TASK_1_QUESTION="Save cockpit socket status in /tmp/exam/ch12_04_cockpit.txt"
...
TASK_2_QUESTION="Save firewall cockpit query in /tmp/exam/ch12_04_firewall.txt"
