...
TASK_1_HINT="Suggested command: printf 'name=rhcsa-07\\nversion=0.0.1\\n' > /tmp/exam/ch12_07.toml. Explanation: > overwrites the destination with standard output. printf writes deterministic text, including the requested line breaks."
TASK_1_COMMAND_1="printf 'name=rhcsa-07\\nversion=0.0.1\\n' > /tmp/exam/ch12_07.toml"

TASK_2_QUESTION="Append the following exact line(s) to /tmp/exam/ch12_07.toml without removing its existing content: \"[[packages]]\"; \"name=bash\"; \"version=*\"."
TASK_2_HINT="Suggested command: printf '[[packages]]\\nname=bash\\nversion=*\\n' >> /tmp/exam/ch12_07.toml. Explanation: >> appends and preserves existing file content. printf writes deterministic text, including the requested line breaks."
