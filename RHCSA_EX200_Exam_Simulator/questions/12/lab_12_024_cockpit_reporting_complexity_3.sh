...
TASK_1_QUESTION="systemctl status cockpit.socket --no-pager and write both standard output and standard error to /tmp/exam/ch12_24_cockpit.txt."
...
TASK_2_QUESTION="firewall-cmd --query-service=cockpit and write both standard output and standard error to /tmp/exam/ch12_24_firewall.txt."
