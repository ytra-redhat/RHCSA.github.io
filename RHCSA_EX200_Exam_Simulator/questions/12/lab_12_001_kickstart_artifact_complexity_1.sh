...
IS_LAB=true
LAB_ID="ch12_001_kickstart_artifact_complexity_1"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch12_01* /tmp/rhcsa_12_01 /var/tmp/rhcsa_12_01.img
}

_check_task_1_live() {
  grep -Fxq reboot /tmp/exam/ch12_01.ks
}

_check_task_2_live() {
  grep -Fxq "timezone UTC" /tmp/exam/ch12_01.ks
}
