...
IS_LAB=true
LAB_ID="ch12_009_cockpit_reporting_complexity_1"
...
TASK_1_QUESTION="Save cockpit socket status in /tmp/exam/ch12_09_cockpit.txt"
...
TASK_2_QUESTION="Save firewall cockpit query in /tmp/exam/ch12_09_firewall.txt"
...
prepare_lab() {
  mkdir -p /tmp/exam
  rm -rf /tmp/exam/ch12_09* /tmp/rhcsa_12_09 /var/tmp/rhcsa_12_09.img
}

_check_task_1_live() {
  [[ -f /tmp/exam/ch12_09_cockpit.txt ]]
}

_check_task_2_live() {
  [[ -f /tmp/exam/ch12_09_firewall.txt ]]
}
